...
export interface InfinityInterface extends utils.Interface {
  functions: {
    ...
    "ownerFunction()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ownerFunction",
    values?: undefined
  ): string;
...
export interface Infinity extends BaseContract {
  ...
  functions: {
    ...
    ownerFunction(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    ownerFunction(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ownerFunction(overrides?: CallOverrides): Promise<PopulatedTransaction>;
